...
def validate_financial_input_integrity(
    ...
    Raises:
        PerfaudError: If currency metadata is unsafe, monetary units conflict, or
...
def _rows_not_identical_in_other_snapshot(
    ...
    row_index = "__perfaud_integrity_row_index"
    occurrence = "__perfaud_integrity_occurrence"
