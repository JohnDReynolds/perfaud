...
from perfaud.specification import Specification, PORTFOLIO_COMPARISON_LEVEL
...
from perfaud.data_issues.vocabulary import DATA_ISSUE_REGISTRY, DataIssueType
        ...
        rows.append(
            _issue_row(
                ...
                explanation=(
                    ...
                    "market value, so an aperfaudently reasonable value does not "
            ...
            issues.append(
                _issue_row(
                    ...
                    explanation=(
                        ...
                        "apart. perfaud did not observe every intervening day; review "
        ...
        rows.append(
            _issue_row(
                ...
                explanation=(
                    ...
                    "classification mapping. perfaud does not choose which value is "
                    "correct."
                ),
            )
        )
