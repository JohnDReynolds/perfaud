...
from perfaud import conservation as pc_conservation
...
_LINEAGE_ROW_INDEX: Final[str] = "__perfaud_lineage_row_index"
_DERIVED_LOCATOR: Final[str] = "__perfaud_derived_locator"
_FINGERPRINT_LOCATOR: Final[str] = "__perfaud_fingerprint_locator"
...
def assert_finding_source_lineage(findings: pl.DataFrame) -> None:
    ...
    Raises:
        PerfaudError: If the locator column is absent, blank, or inconsistent for
...
def cause_lineage_table(
    ...
    *,
    ...
    Raises:
        PerfaudError: If a source-backed cause cannot be traced to a finding.
    """
    audit_trail = (
...
def assert_bidirectional_report_lineage(
    ...
    *,
    ...
    Raises:
        PerfaudError: If source-record identity is missing or a source-backed cause
