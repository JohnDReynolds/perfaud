...
_NORMALIZED_PORTFOLIO_ID = "_perfaud_normalized_portfolio_id"
_NORMALIZED_ROW_CURRENCY = "_perfaud_normalized_row_currency"
_AUTHORITATIVE_BASE_CURRENCY = "_perfaud_authoritative_base_currency"
...
def with_authoritative_base_currency(
    ...
    *,
    ...
    Raises:
        PerfaudError: If one portfolio has conflicting performance-row currencies
