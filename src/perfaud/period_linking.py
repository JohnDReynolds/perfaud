...
_SOURCE_ORDER = "_perfaud_source_order"
_SCOPE_ORDER = "_perfaud_scope_order"
_PRIOR_FROM_DATE = "_perfaud_prior_from_date"
_PRIOR_THRU_DATE = "_perfaud_prior_thru_date"
...
def validate_portfolio_periods(
    ...
    *,
    ...
    Raises:
        PerfaudError: If a period is reversed or two periods overlap within the
    ...
    ordered_periods = (
        ...
        # Exact duplicates remain the comparison-key validator's responsibility.
...
def validate_dated_evidence_assignments(
    ...
    *,
    ...
    Raises:
        PerfaudError: If evidence for a compared portfolio maps to zero or more than
