...
from perfaud.base_currency import with_authoritative_base_currency
from perfaud.currency_basis import normalize_currency_columns
from perfaud.extract_contract import validate_transaction_extract_contract
...
class TransactionsLoader:
    ...
    def load(self, snapshot_key: SnapshotKey) -> pl.DataFrame | None:
        ...
        Raises:
            PerfaudError: If the source exists but required columns cannot be
                resolved.
        """
