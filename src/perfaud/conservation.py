...
_EFFECT_KEY_PREFIX: Final[str] = "__perfaud_effect_key_"
...
def assert_complete_finding_audit_trail(
    ...
    Raises:
        PerfaudError: If any source finding is missing, changed, duplicated by the
...
def assert_cause_conservation(
    ...
    *,
    ...
    Raises:
        PerfaudError: If a cause disappears, has an inconsistent disposition, uses
