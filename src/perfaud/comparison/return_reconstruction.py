...
from perfaud.currency_basis import base_currency_monetary_value
...
def portfolio_return_reconstruction_checks(
    ...
    *,
    ...
    Raises:
        PerfaudError: If opted-in YAML is malformed or required source files are
            unavailable.
    """
...
def _return_reconstruction_flow_weight(
    ...
    *,
    ...
    if reconstruction.inclusion_rule is None:
        raise PerfaudError("modified_dietz reconstruction requires inclusion_rule.")
...
def _required_base_currency_value(
    ...
    *,
    ...
    Raises:
        PerfaudError: If a nonzero row-currency value needs translation but its
