...
def _transaction_impact_policies(
    ...
    Raises:
        PerfaudError: If transaction impact method configuration is malformed or
...
def _security_return_impact_policies(
    ...
    Raises:
        PerfaudError: If a security comparison omits or malforms the required
...
def _holding_impact_policies(
    ...
    Raises:
        PerfaudError: If holding impact method configuration is malformed or
            names an unsupported method.
    """
...
def _price_impact_policies(
    ...
    Raises:
        PerfaudError: If price impact method configuration is malformed or names
...
def _evidence_only_impact_policies(
    ...
    Raises:
        PerfaudError: If evidence-only impact configuration is malformed or names
