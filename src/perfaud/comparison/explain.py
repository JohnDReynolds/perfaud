...
from perfaud.comparison import _transaction_diagnostics as tx_diagnostics
...
from perfaud.comparison.modified_dietz import (
...
_RANK_TARGET_ORDER = "__perfaud_rank_target_order"
_RANK_EVIDENCE_ORDER = "__perfaud_rank_evidence_order"
_RANK_TARGET_PORTFOLIO = "__perfaud_rank_target_portfolio"
_RANK_TARGET_SECURITY = "__perfaud_rank_target_security"
_RANK_TARGET_FROM_DATE = "__perfaud_rank_target_from_date"
_RANK_TARGET_THRU_DATE = "__perfaud_rank_target_thru_date"
_RANK_ROLE_SCORE = "__perfaud_rank_role_score"
_RANK_DATASET_SCORE = "__perfaud_rank_dataset_score"
_RANK_DELTA_SCORE = "__perfaud_rank_delta_score"
_RANK_ABSOLUTE_SORT = "__perfaud_rank_absolute_sort"
...
def _rank_evidence_relation(
    ...
    scored = relation.with_columns(
        ...
        *[
            ...
            .cast(pl.String)
            .fill_null("None")
            .alias(f"__perfaud_rank_sort_{column}")
    ...
    sort_columns = [
        ...
        PRIORITY_SCORE,
        _RANK_ABSOLUTE_SORT,
        *[f"__perfaud_rank_sort_{column}" for column in _RANK_STRING_SORT_COLUMNS],
        _RANK_EVIDENCE_ORDER,
    ]
    ranked = scored.sort(
        sort_columns,
...
def _required_impact_number(value: object, field_name: str) -> float:
    ...
    Raises:
        PerfaudError: If an impact predicate admitted a nonnumeric or nonfinite
            calculation input.
    """
