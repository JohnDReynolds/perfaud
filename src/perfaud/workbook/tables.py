...
from perfaud import conservation as _pc_conservation
from perfaud import executive_summary as _executive_summary
...
from perfaud import lineage as _pc_lineage
from perfaud import rendering as _pc_rendering
from perfaud import review as _review
from perfaud.workbook import writer as _pc_workbook
from perfaud.workbook import formula_rows as _formula_rows
from perfaud.workbook import guidance as _guidance
from perfaud.workbook import layout as _layout
from perfaud.workbook import reconstruction as _workbook_reconstruction
from perfaud.workbook import rows as _rows
from perfaud.workbook import source_allocation as _source_allocation
from perfaud.data_issues import checks as _data_issue_checks
...
_with_period_review_key = _review.with_period_review_key
_with_security_review_key = _review.with_security_review_key
...
def write_audit_review_workbook(
    ...
    *,
    ...
    Raises:
        PerfaudError: If the Excel workbook dependency is not installed.
...
def audit_review_workbook_sheets(
    ...
    *,
    ...
    data_issues_sheet = next(
        ...
        if sheet.artifact_name == _review.DATA_ISSUES_ARTIFACT
    )
    executive_summary_sheet = _pc_workbook.ReviewWorkbookSheet(
        artifact_name=_review.EXECUTIVE_SUMMARY_ARTIFACT,
        sheet_name=_review.EXECUTIVE_SUMMARY_SHEET,
...
def _return_reconstruction_summary_sheets(
    ...
    return (
        _pc_workbook.ReviewWorkbookSheet(
            artifact_name=_review.RECONSTRUCTION_SUMMARY_ARTIFACT,
            sheet_name=_review.RECONSTRUCTION_SUMMARY_SHEET,
            table=summary,
...
def _return_reconstruction_sheets(
    ...
    return (
        _pc_workbook.ReviewWorkbookSheet(
            artifact_name=_review.RETURN_RECONSTRUCTION_CHECKS_ARTIFACT,
            sheet_name=_review.RETURN_RECONSTRUCTION_CHECKS_SHEET,
...
def _security_return_reconstruction_sheets(
    ...
    return (
        _pc_workbook.ReviewWorkbookSheet(
            artifact_name=(_review.SECURITY_RETURN_RECONSTRUCTION_CHECKS_ARTIFACT),
            sheet_name=_review.SECURITY_RETURN_RECONSTRUCTION_CHECKS_SHEET,
            table=reconstruction_checks,
...
def _portfolio_differences_sheet(
    ...
    *,
    ...
    return _pc_workbook.ReviewWorkbookSheet(
        artifact_name=_review.PERFORMANCE_DIFFERENCES_ARTIFACT,
        sheet_name=_review.PERFORMANCE_DIFFERENCES_SHEET,
...
def _shared_detail_sheets(
    ...
    *,
    ...
    detail_sheets = [
        _pc_workbook.ReviewWorkbookSheet(
            artifact_name=_review.PERFORMANCE_DIFFERENCE_CAUSES_ARTIFACT,
            sheet_name=_review.PERFORMANCE_DIFFERENCE_CAUSES_SHEET,
            table=causes_table,
            columns=_layout.workbook_underlying_cause_columns(),
            labels=_layout.workbook_column_labels(),
        ),
        _pc_workbook.ReviewWorkbookSheet(
            artifact_name=_review.DATA_ISSUES_ARTIFACT,
            sheet_name=_review.DATA_ISSUES_SHEET,
            table=(
...
def _assert_visible_explanation_contract(
    ...
    *,
    ...
    Raises:
        PerfaudError: If a visible source row omits its field, direction, or
...
def _assert_explanation_invariants(
    ...
    *,
    ...
    Raises:
        PerfaudError: If cause impacts do not reconcile to the summary, a fully
