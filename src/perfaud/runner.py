...
import perfaud.comparison.explain as _pc_explain
import perfaud.field_roles as _field_roles
import perfaud.lineage as _pc_lineage
...
import perfaud.schema as pc_cols
...
class ComparisonViews:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            values: Already-loaded YAML values used by workspace execution.
        """
    ...
    def findings(self, comparison_level: str) -> pl.DataFrame:
        ...
        Raises:
            PerfaudError: If the level is unsupported or its required inputs and
    ...
    *,
    ...
    Args:
        ...
        comparison_level: Optional primary performance-result level override.
            ...
            user-facing ``perfaud run`` command always supplies this explicitly
    ...
    Raises:
        PerfaudError: If the comparison specification is invalid, required files
...
def validate_causal_attribution_ready(findings: pl.DataFrame) -> None:
    ...
    Raises:
        PerfaudError: If any changed portfolio period still has missing setup or
...
def validate_yaml_setup_complete(findings: pl.DataFrame) -> None:
    ...
    Raises:
        PerfaudError: If a changed field has no explicit accounting role, or a
