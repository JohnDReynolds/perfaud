...
This folder contains implementation-facing contracts for perfaud demo, validation,
and test behavior.
...
| [demo_extract_availability.md](demo_extract_availability.md) | You need perfaud's generated extract requirements, likely source paths, and packaged-demo column availability. |
