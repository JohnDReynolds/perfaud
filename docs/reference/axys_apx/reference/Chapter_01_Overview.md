...
or evidence that perfaud reproduces native Axys/APX methodology. Product behavior
...
5. Use `../contracts/` only for perfaud implementation behavior; contracts are not
