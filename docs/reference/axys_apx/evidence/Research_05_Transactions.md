...
- Reader explanations, examples, audit guidance, and canonical Unknowns belong
  in Chapter 05.
- Current perfaud behavior and fixture coverage belong in
...
contract may apply narrower behavior because it also reflects perfaud tests,
...
an Unknown changes. Update the YAML contract only when perfaud behavior, fixture
