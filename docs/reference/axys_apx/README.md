...
4. Use the contracts and YAML files when implementing or validating perfaud demo
   behavior.
...
| Transaction behavior used by perfaud demos, tests, or validation | [transaction_semantics_matrix.yaml](contracts/transaction_semantics_matrix.yaml) | [transaction_semantics_matrix.md](contracts/transaction_semantics_matrix.md) |
...
- Keep implementation contracts conservative. They should describe supported
  perfaud behavior, not imply official vendor methodology.
